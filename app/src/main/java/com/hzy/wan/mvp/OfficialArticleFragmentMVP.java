...
import com.hzy.wan.mvp.presenter.OfficialArticlePresenter;
import com.hzy.wan.mvp.view.OfficialArticleView;
import org.jetbrains.annotations.NotNull;

import java.util.List;

public class OfficialArticleFragmentMVP extends BaseLazyMVPFragment<OfficialArticleView, OfficialArticlePresenter> implements OfficialArticleView {
    ...
    protected void lazyLoad() {
        mPresent = new OfficialArticlePresenter(this);
